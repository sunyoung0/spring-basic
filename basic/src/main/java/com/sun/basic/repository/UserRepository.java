package com.sun.basic.repository;
...
// description : Repository - 레이어드 아키텍쳐 상의 데이터 접근 영역 //
// description : 데이터 베이스와 관련된 작업들을 담당하는 구역 //

// description : @Repository - 해당 클래스가 Repository 영역임을 명시 //
// description : @Component를 포함하고 있어서 Spring으로 등록할 수 있음 //
@Repository

// description : JpaRepository<Entity, PK> - JPA를 이용한 리포지토리 생성시에 //
...
public interface UserRepository extends JpaRepository<UserEntity, String> {
	...
	// description   findBy : 조회할 때 사용 - 해당 문구 뒤에 조건을 추가 //
