package com.sun.basic.provider;
...
public class JwtProvider {
	...
	public String create(String sub) {
		...
		String jwt = Jwts.builder()
								 ...
								 // description : JWT payload의 sub 키에 들어갈 값을 지정 (소유자, 누가 만들었는가에 대한 것, 인증을 한 당사자, 매개변수로 받아옴) //
								 .setSubject(sub)
	...
	public String validate(String jwt) {
		...
		// description : 검증 완료 시에 payload에 있는 sub값 반환 //
